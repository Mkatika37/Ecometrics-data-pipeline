  ...
  create  table "weather_db"."public_marts"."mart_combined_daily__dbt_tmp"
...
FROM "weather_db"."public_marts"."mart_daily_weather" w
LEFT JOIN "weather_db"."public_marts"."mart_daily_aqi" a
  ON w.date = a.date
